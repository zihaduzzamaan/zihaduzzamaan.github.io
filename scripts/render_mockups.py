...
def make_campus_welfare():
    ...
    img.save(os.path.join(PROJECT_ROOT, "public/projects/campus_welfare.jpg"), quality=95)
...
def make_roadmap_tracker():
    ...
    img.save(os.path.join(PROJECT_ROOT, "public/projects/roadmap_tracker.jpg"), quality=95)
...
def make_hardware_suite():
    ...
    img.save(os.path.join(PROJECT_ROOT, "public/projects/hardware_suite.jpg"), quality=95)
